 ...
 * MIT License
 *
 * @brief Read buttons from an MCP23017 through a logical pressed-state callback.
 *
 * @file 04_PortExpander.ino
 ...
 * If the key matches our configured buttons, read from MCP; otherwise fall back to MCU GPIO.
 */
